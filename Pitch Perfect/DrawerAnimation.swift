...
extension DrawerAnimation : UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        if presenting == true {
            ...
            toVC.view.frame = CGRectMake(0, containerView.frame.height, containerView.frame.width, containerView.frame.height)
            toVC.view.alpha = 0
        } else {
            ...
            fromVC.view.frame = CGRectMake(0, drawerOffset, containerView.frame.width, containerView.frame.height)
        }
        ...
        UIView.animateWithDuration(transitionDuration(transitionContext), delay: 0.0, usingSpringWithDamping: springDamping, initialSpringVelocity: springVelocity, options: UIViewAnimationOptions.CurveEaseInOut, animations: { () -> Void in
            ...
            if self.presenting == true {
                toVC.view.frame = CGRectMake(0, self.drawerOffset, containerView.frame.width, containerView.frame.height)
                toVC.view.alpha = 1
                ...
                fromVC.view.frame = CGRectMake(0, containerView.frame.height, containerView.frame.width, containerView.frame.height)
                fromVC.view.alpha = 0
